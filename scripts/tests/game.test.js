...
describe('newGame works correctly', () => {
    ...
    test('should be 1 element in currentGame', () => {
        expect(game.currentGame.length).toEqual(1);
    });
    test('should display 0 in element with id of score', () => {
...
describe('gameplay works correctly', () => {
    ...
    test('showTurns should update game.turnNmber', () => {
        game.turnNumber = 42;
        showTurns();
        expect(game.turnNumber).toEqual(0);
    });
    test('should increment score if turn correct', () => {
